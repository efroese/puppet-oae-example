    ...
    $basic_sis_batch_school_properties = {
        'UCB' => {
            ...
            'oae_batch_params'    => {
                ...
                'extraPropertyNames@com.rsmart.customer.integration.processor.cle.CleUserProcessor' => shellquote('["eppn"]'),
                'columns@com.rsmart.customer.integration.processor.cle.CleUserProcessor' => '8',
                'termMap@com.rsmart.customer.integration.processor.cle.CleCourseProcessor' => shellquote('{ "Win Qtr 12": "Winter Quarter 2012", "Spr Sem 12": "Spring Semester 2012", "Spr Qtr 12": "Spring Quarter 2012" }'),
            },
        },
        'UCD' => {
